...
*Hello {} !*
────────────────────────
🔥 UwU,I'm an anime theme bot designed to help manage your telegram group with a lot features.
🔥 Maintained by [ReYZ](https://t.me/ryinaja)
────────────────────────
...
buttons = [
    ...
    [
        InlineKeyboardButton(
            text="sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ​", url="https://github.com/memek"
        ),
        InlineKeyboardButton(
    ...
    [
        InlineKeyboardButton(
            text="➗ ᴀᴅᴅ ᴇʟᴀɪɴᴀ ᴛᴏ ʏᴏᴜʀ ɢʀᴜʙ ➗", url="t.me/ElainaZRobot?startgroup=new"),
    ],
]
...
EMI_IMG = "https://telegra.ph/file/032738e2726c08d04859a.jpg"
...
def Skyzu_about_callback(update, context):
    ...
    if query.data == "Skyzu_":
        query.message.edit_text(
            ...
            "\n\n_Elaina's licensed under the GNU General Public License v3.0_"
            "\n\n Click on button bellow to get basic help for ElainaRobot.",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
        ...
        query.message.edit_text(
            ...
            "\nCongragulations, ElainaRobot now ready to manage your group."
            "\n\n*Admin Tools*"
        ...
        query.message.edit_text(
            text="*๏ Elaina support chats*"
            "\nJoin My Support Group/Channel for see or report a problem on Elaina.",
            parse_mode=ParseMode.MARKDOWN,
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="sᴜᴘᴘᴏʀᴛ​", url="t.me/ElainaSupport"),
                 ],
                 [
                    InlineKeyboardButton(text="ɢᴏ ʙᴀᴄᴋ​", callback_data="Skyzu_"),
        ...
        query.message.edit_text(
            text=f"<b>๏ Credis for ELAINA ROBOT</b>\n"
            f"\nHere Developers Making The ELAINA ROBOT",
            parse_mode=ParseMode.HTML,
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="ReYZ", url="t.me/ryinaja"),
                    InlineKeyboardButton(text="Arya", url="t.me/Badboyanim"),
                 ],
                 [
                    InlineKeyboardButton(text="ɢᴏ ʙᴀᴄᴋ​", callback_data="Skyzu_"),
