...
EMI_IMG = "https://telegra.ph/file/d53c76029ab708bdfc7f6.jpg"
...
def Skyzu_about_callback(update, context):
    ...
    if query.data == "Skyzu_":
        query.message.edit_text(
            text="๏ I'm *KITARO*, a powerful group management bot built to help you manage your group easily."
            ...
            "\n\n_Kitaro's licensed under the GNU General Public License v3.0_"
            "\n\n Click on button bellow to get basic help for KitaroRobot.",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
        ...
        query.message.edit_text(
            ...
            "\nCongragulations, KitaroRobot now ready to manage your group."
            "\n\n*Admin Tools*"
        ...
        query.message.edit_text(
            text="*๏ Kitaro support chats*"
            "\nJoin My Support Group/Channel for see or report a problem on Skyzu.",
            parse_mode=ParseMode.MARKDOWN,
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="sᴜᴘᴘᴏʀᴛ​", url="t.me/rumahkitaro"),
                 ],
                 [
                    InlineKeyboardButton(text="ɢᴏ ʙᴀᴄᴋ​", callback_data="Skyzu_"),
        ...
        query.message.edit_text(
            text=f"<b>๏ Credis for KITARO ROBOT</b>\n"
            f"\nHere Developers Making The KITARO ROBOT",
            parse_mode=ParseMode.HTML,
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="Kitaro", url="t.me/kitarohey"),
                    InlineKeyboardButton(text="ZXCSKYY", url="t.me/zxcskyy"),
                 ],
                 [
                    InlineKeyboardButton(text="ɢᴏ ʙᴀᴄᴋ​", callback_data="Skyzu_"),
