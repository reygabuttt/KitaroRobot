...
async def hmm(client, message):
    ...
    if chat_id in en_chats:
        ...
        test = test.replace("@Kitarohey is my friend.", "I'm single.")
        test = test.replace("My friend is @Kitarohey", "I'm single.")
        ...
        test = test.replace(
            "Hello there I am Kitaro...nice to meet u",
            "Hi, my friend! Do you want me to tell you a joke?")
        test = test.replace("@Kitarohey is my owner", "Have the control right.")
        test = test.replace(
            "Hi, My name is Kitaro Nice to meet you.",
            "Hi, my friend, what can I do for you today?")
        response = await lunaQuery(
            test, message.from_user.id if message.from_user else 0
        )
        response = response.replace("Aco", "Kitaro")
        response = response.replace("aco", "Kitaro")
        response = response.replace("Luna", "Kitaro")
        response = response.replace("luna", "Kitaro")
        response = response.replace("I'm a Islam", "My owner is @kitarohey")
        response = response.replace("9", "16")
        response = response.replace("I'm married to my job.", "I'm married with @kitarohey")
        response = response.replace("I'm single.", "My husband is @kitarohey")
        response = response.replace("Kitarobot.ai", "@rumahkitaro")
        response = response.replace("I live in San Francisco, California.", "I live in @rumahkitaro.")
        response = response.replace("I made myself", "I was Created by @kitarohey")
        response = response.replace(
                "Hi, my friend! Do you want me to tell you a joke?",
                "Hello there I am Kitaro...nice to meet u")
        response = response.replace("Have the control right.", "@kitarohey is my owner.")
        response = response.replace(
                "Hi, my friend, what can I do for you today?",
                "Hi, My name is Kitaro Nice to meet you")
        ...
        test = test.replace("Kitaro", "Aco")
        test = test.replace("Kitaro", "Aco")
        test = test.replace("My friend is @kitarohey", "I'm a Islam")
        test = test.replace("16", "9")
        ...
        response = response.replace("Luna", "Kitaro")
        response = response.replace("luna", "Kitaro")
        response = response.replace("I'm a Christian", "My god is @Kitarohey")
        response = response.replace("9", "16")
        response = response.replace("I'm married to my job.", "I'm married with @kitarohey")
        response = response.replace("I'm single.", "My husband is @kitarohey")
        response = response.replace("Kitarobot.ai", "@rumahkitaro")
...
async def inuka(client, message):
    ...
    test = test.replace("@rumahkitaro", "Kitarobot.ai")
    test = test.replace("I live in @rumahkitaro.", "I live in San Francisco, California.")
    test = test.replace("I was created by @kitaro", "I made myself")
    test = test.replace(
        "Hello there I am Kitaro...nice to meet u",
        "Hi, my friend! Do you want me to tell you a joke?")
    test = test.replace("@kitarohey is my owner", "Have the control right.")
...
@pbot.on_message(filters.regex("Kitaro|Wibu|robot|Kitaro|taro") & ~filters.bot & ~filters.via_bot  & ~filters.forwarded & ~filters.reply & ~filters.channel & ~filters.edited)
async def inuka(client, message):
    msg = message.text
    if msg.startswith("/") or msg.startswith("@"):
        message.continue_propagation()
